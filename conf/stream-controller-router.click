...
rt :: StaticIPLookup(
   ...
   // LOCAL HOST
   10.0.2.15/255.255.255.255 0,
   192.168.148.70/255.255.255.255 0,
   192.168.147.70/255.255.255.255 0,
   // BROADCAST
   10.0.2.255/255.255.255.255 0,
   192.168.148.255/255.255.255.255 0,
   192.168.147.255/255.255.255.255 0,
...
out0 :: Queue(128) -> todevice0 :: ToDevice(enp0s3);
c0[0] -> ar0 :: ARPResponder(10.0.2.15 02:12:4b:e9:82:8c) -> out0;
arpq0 :: ARPQuerier(10.0.2.15, 02:12:4b:e9:82:8c) -> out0;
c0[1] -> [1]arpq0;
//c0[2] -> Strip(14) -> CheckIPHeader -> IPPrint("RCV-enp0s3") -> Discard;
c0[2] -> Strip(14) -> CheckIPHeader -> [0]rt;
...
out1 :: Queue(128) -> todevice1 :: ToDevice(enp0s8);
c1[0] -> ar1 :: ARPResponder(192.168.148.70 08:00:27:c2:73:e7) -> out1;
arpq1 :: ARPQuerier(192.168.148.70, 08:00:27:c2:73:e7) -> out1;
c1[1] -> [1]arpq1;
c1[2] -> Strip(14) -> CheckIPHeader -> [0]rt;
//c1[2] -> Strip(14) -> CheckIPHeader -> IPPrint("RCV-enp0s8") -> Discard;
...
out2 :: Queue(128) -> todevice2 :: ToDevice(enp0s9);
c2[0] -> ar2 :: ARPResponder(192.168.147.70 08:00:27:63:4f:c6) -> out2;
arpq2 :: ARPQuerier(192.168.147.70, 08:00:27:63:4f:c6) -> out2;
c2[1] -> [1]arpq2;
//c2[2] -> Strip(14) -> CheckIPHeader -> IPPrint("RCV-enp0s9") -> Discard;
c2[2] -> Strip(14) -> CheckIPHeader -> [0]rt;
//c2[3] -> Print("enp0s9 non-IP") -> Discard;
c2[3] -> Discard;


// Local delivery
//toh :: Print(ToHost) -> Discard;
//rt[0] -> toh;
rt[0] -> Discard;
